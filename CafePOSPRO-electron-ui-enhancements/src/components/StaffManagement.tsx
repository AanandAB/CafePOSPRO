  ...
  useEffect(() => {
    ...
    const getNetworkInterfaces = async () => {
      ...
      try {
        ...
        console.log("Detected network URLs:", urls);
        ...
        console.log("Selected default IP for staff:", defaultIP);
    ...
    void (async () => {
      try {
        await updateStaff({
          ...
          pin: pin || undefined, // Add PIN to update
          monthlySalary: monthlySalary ? Number(monthlySalary) : undefined,
        });
                ...
                <tr key={staffMember._id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <div className="flex justify-end gap-2">
                      ...
                      <button
                        onClick={() => {
                          void handleGenerateNewPIN(
                            staffMember._id as Id<"staff">
                          );
                        }}
